  ...
  <div class="row page-titles">
    ...
    <div class="col-md-7 align-self-center">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href= "{!! route('cms.index') !!}" >{{trans('lang.cms_plural')}}</a></li>
      ...
      <div class="card-body">
        ...
        <form action="{{ route('cms.store') }}" method="post"  enctype="multipart/form-data" id="">
          ...
          <div class="form-group col-12 text-center btm-btn">
            ...
            <a href="{!! route('cms.index') !!}" class="btn btn-default"><i class="fa fa-undo"></i>{{ trans('lang.cancel')}}</a>
          </div>
          </form>
  </div>
  </div>
