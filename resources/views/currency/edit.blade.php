	...
	<div class="row page-titles">
		...
		<div class="col-md-7 align-self-center">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item"><a href= "{!! route('currency.index') !!}" >{{trans('lang.currency_plural')}}</a></li>
  ...
  <div class="row">
	...
	<div class="card-body">
		...
		<div class="error_top"></div>
			...
			@endif
		<form action="{{ route('currency.update',$currency->id) }}" method="post"  enctype="multipart/form-data" id="create_driver">
		@csrf
        @method("PUT")
			<div class="row restaurant_payout_create">
          	<div class="restaurant_payout_create-inner">
          		<fieldset>
              		<legend>{{trans('lang.currency_edit')}}</legend>

						<div class="form-group row width-50">
							<label class="col-3 control-label">{{trans('lang.currency_plural')}}</label>
							<div class="col-7">
								<input type="text" class="form-control libelle" name="libelle" value="{{$currency->libelle}}">
						...
						<div class="form-group row width-50">
							...
							<div class="col-7">
								<input type="text" class="form-control code" name="symbol" value="{{$currency->symbole}}">
					...
					<div class="form-group row width-50">
						...
						<div class="col-7">
							<input type="number" class="form-control " name="decimal_digit" value="{{$currency->decimal_digit}}">
					...
					<div class="form-group row width-50">
						<div class="form-check">
							<input type="checkbox" class="symbol_at_right" id="symbol_at_right" name="symbol_at_right" {{$currency->symbol_at_right=="true"?"checked":""}} >
			...
			<div class="form-group col-12 text-center btm-btn" >
				...
				<a href="{!! route('currency.index') !!}" class="btn btn-default"><i class="fa fa-undo"></i>{{ trans('lang.cancel')}}</a>
			</div>
