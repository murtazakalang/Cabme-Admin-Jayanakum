            ...
            <div class="col-12">
                <div class="card pb-4">
                    <div class="card-body">
                        ...
                        @endif
                        <form action="{{route('driver.updatedocument',['id' => $id])}}" method="post" enctype="multipart/form-data" id="create_driver">
                            @csrf
                            @method("PUT")
                            ...
                            <div class="form-group col-12 text-center btm-btn">
                                ...
                                <a href="{!! route('driver.documentView',['id' => $id]) !!}" class="btn btn-default"><i class="fa fa-undo"></i>{{ trans('lang.cancel')}}</a>
                            </div>
                        </form>
                </div>
            </div>
