                        ...
                        <div class="card-body">
                            ...
                            <div class="row restaurant_payout_create">
                                <div class="restaurant_payout_create-inner">
                                    <fieldset>
                                        <legend><i class="mr-3 fa fa-cc-mercadopago"></i>{{trans('lang.mercadopago')}}
                                        </legend>
                                        @foreach($mercadopago as $data)
                                            ...
                                            <div class="form-check width-100">
                                                <input type="checkbox" class="sand_box_mode" id="sand_box_mode" value=""
                                            ...
                                            <div class="form-group row width-100">
                                                <label
                                                    class="col-3 control-label">{{trans('lang.app_setting_mercadopago_key')}}</label>
                                                <div class="col-7">
                                            ...
                                            <div class="form-group row width-100">
                                                ...
                                                <div class="col-7">
                                                    <input type="password"
                                                        class=" col-7 form-control mercadopago_accesstoken"
