                        ...
                        <div class="card-body">
                            ...
                            <div class="row restaurant_payout_create">
                                <div class="restaurant_payout_create-inner">
                                    <fieldset>
                                        <legend><i
                                                class="mr-3 fa fa-cc-paystack"></i>{{trans('lang.app_setting_paystack')}}
                                        </legend>
                                        @foreach($paystack as $data)
                                            ...
                                            <div class="form-check width-100">
                                                <input type="checkbox" class="enable_paystack" id="enable_paystack"
                                                    value="{{$data->isEnabled}}" @if($data->isEnabled == 'true')
                                                    checked=checked @endif>
                                                <label class="col-3 control-label"
                                                    for="enable_paystack">{{trans('lang.active')}}</label>
                                            </div>
                                            <div class="form-check width-100">
                                                <input type="checkbox" class="sandbox_enable" id="sandbox_enable"
                                                    @if($data->isSandboxEnabled == 'true') checked=checked @endif>
                                                <label class="col-3 control-label"
                                                    for="sandbox_enable">{{trans('lang.sandbox_enable_payfast')}}</label>
                                            </div>
                                            <div class="form-group row width-100">
                                                <label
                                                    class="col-3 control-label">{{trans('lang.app_setting_paystack_key')}}</label>
                                                <div class="col-7">
                                                    <input type="password" class="form-control paystack_key"
                                            ...
                                            <div class="form-group row width-100">
                                                <label
                                                    class="col-3 control-label">{{trans('lang.app_setting_paystack_public_key')}}</label>
                                                <div class="col-7">
                                                    <input type="password" class=" col-7 form-control paystack_secret"
                                            ...
                                            <div class="form-group row width-100">
                                                <label
                                                    class="col-3 control-label">{{trans('lang.app_setting_paystack_callback_url')}}</label>
                                                <div class="col-7">
                                                    <input type="password" class=" col-7 form-control callback_url"
                                                        value="{{ $data->callback_url }}">
                                                </div>
                                            </div>
                                            <div class="form-group row width-100">
                                                <label
                                                    class="col-3 control-label">{{trans('lang.app_setting_paystack_webhook_url')}}</label>
                                                <div class="col-7">
                                                    <input type="password" class=" col-7 form-control webhook_url"
