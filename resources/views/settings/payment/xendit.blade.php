                        ...
                        <div class="card-body">
                            ...
                            <div class="row restaurant_payout_create">
                                <div class="restaurant_payout_create-inner">
                                    <fieldset>
                                        @foreach($xendit as $data)
                                            <legend>{{trans('lang.xendit')}}</legend>
                                            <div class="form-check width-100">
                                                <input type="hidden" class="id" id="id" value="{{$data->id}}">
                                                <input type="checkbox" class="enable_xendit" value="{{$data->isEnabled}}"
                                                    id="enable_xendit" @if($data->isEnabled == "true") checked @endif>
                                                <label class="col-3 control-label"
                                                    for="enable_xendit">{{trans('lang.app_setting_enable_xendit')}}</label>
                                            </div>
                                            <div class="form-check width-100">
                                                <input type="checkbox" class="enable_xendit_sandbox"
                                                    value="{{$data->isSandboxEnabled}}" id="enable_xendit_sandbox"
                                                    @if($data->isSandboxEnabled == "true") checked @endif>
                                                <label class="col-3 control-label"
                                                    for="enable_xendit_sandbox">{{trans('lang.app_setting_enable_xendit_sandbox')}}</label>
                                            </div>
                                            <div class="form-group row width-100">
                                                <label
                                                    class="col-3 control-label">{{trans('lang.app_setting_xendit_api_key')}}</label>
                                                <div class="col-7">
                                                    <input type="password" class="form-control api_key"
                                                        value="{{$data->key}}">
...
<script>
    ...
    $(".edit-setting-btn").click(function () {
        ...
        var enableSandbox=$(".enable_xendit_sandbox").is(":checked");
        var api_key = $('.api_key').val();
        var id = $('.id').val();
        var url = "{{ route('payment.xenditUpdate', ':id') }}";
