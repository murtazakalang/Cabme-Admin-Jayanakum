                        ...
                        <div class="card-body">
                            ...
                            <div class="row restaurant_payout_create">
                                <div class="restaurant_payout_create-inner">
                                    <fieldset>
                                        <legend><i
                                                class="mr-3 fa fa-cc-paystack"></i>{{trans('lang.app_setting_flutterwave')}}
                                        </legend>
                                        @foreach($flutterwave as $data)
                                            <input type="hidden" class="id" id="id" value="{{$data->id}}">
                                            <div class="form-check width-100">
                                                <input type="checkbox" class="enable_flutterwave" id="enable_flutterwave"
                                                    value="{{$data->isEnabled}}" @if($data->isEnabled == 'true')
                                                    checked=checked @endif>
                                                <label class="col-3 control-label"
                                                    for="enable_flutterwave">{{trans('lang.active')}}</label>
                                            </div>
                                            <div class="form-check width-100">
                                                <input type="checkbox" class="sandbox_enable" id="sandbox_enable" value=""
                                            ...
                                            <div class="form-group row width-100">
                                                ...
                                                <div class="col-7">
                                                    <input type="password" class="form-control flutter_key"
                                            ...
                                            <div class="form-group row width-100">
                                                ...
                                                <div class="col-7">
                                                    <input type="password" class=" col-7 form-control flutter_secret"
                                            ...
                                            <div class="form-group row width-100">
                                                <label
                                                    class="col-3 control-label">{{trans('lang.app_setting_flutterwave_encry_key')}}</label>
                                                <div class="col-7">
                                                    <input type="password" class=" col-7 form-control flutter_encry_key"
