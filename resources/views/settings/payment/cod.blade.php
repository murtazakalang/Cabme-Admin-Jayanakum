                    ...
                    <div class="card-body">
                        <div class="payment-top-tab mt-3 mb-3">
                            <ul class="nav nav-tabs card-header-tabs align-items-end">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active cod_active_label"
                                        href="{!! url('settings/payment/cod') !!}"><i
                            ...
                            <form>
                                ...
                                <div class="row restaurant_payout_create">
                                    <div class="restaurant_payout_create-inner">
                                        <fieldset>
                                            <legend><i
                                                    class="mr-3 fa fa-money"></i>{{trans('lang.app_setting_cod_short')}}
                                            </legend>
                                            @foreach($cods as $cod)
                                                <div class="form-check width-100">
                                                    <input type="hidden" class="id" id="id" value="{{$cod->id}}">
                                                    <input type="checkbox" class="user_active enable_cod" id="enable_cod"
                                                        value="{{$cod->isEnabled}}" @if($cod->isEnabled == 'true')
