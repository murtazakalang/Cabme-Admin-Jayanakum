...
<div class="page-wrapper">
	<div class="row page-titles">
		<div class="col-md-5 align-self-center">
			<h3 class="text-themecolor">{{trans('lang.edit_parcel_category')}}</h3>
		</div>

		<div class="col-md-7 align-self-center">
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a href="{{url('/dashboard')}}">{{trans('lang.dashboard')}}</a></li>
				<li class="breadcrumb-item"><a href="{!! route('parcel-category.index') !!}">{{trans('lang.parcel_category_plural')}}</a></li>
				<li class="breadcrumb-item active">{{trans('lang.edit_parcel_category')}}</li>
			</ol>
		</div>
	</div>
			...
			<div class="col-12">
				<div class="card pb-4">
						...
						<form action="{{ route('parcel-category.update',$parcelCategory->id) }}" method="post" enctype="multipart/form-data">
							...
							<div class="row restaurant_payout_create">
								<div class="restaurant_payout_create-inner">
									<fieldset>
										<legend>{{trans('lang.edit_parcel_category')}}</legend>
										...
										<div class="form-group row width-100">
											...
											<div class="col-7">
												<textarea rows="2" class="form-control" name="description">{{ $parcelCategory->description}}</textarea>
											</div>
										</div>
					...
					<div class="form-group col-12 text-center btm-btn">
						...
						<a href="{!! route('parcel-category.index') !!}" class="btn btn-default"><i class="fa fa-undo"></i>{{ trans('lang.cancel')}}</a>
					</div>
