...
<div class="page-wrapper">
  <div class="row page-titles">
    <div class="col-md-5 align-self-center">
      <h3 class="text-themecolor">{{trans('lang.driver_reports')}}</h3>
    </div>

    <div class="col-md-7 align-self-center">
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{url('/dashboard')}}">{{trans('lang.dashboard')}}</a></li>
        <li class="breadcrumb-item"><a href= "{!! route('userreport.index') !!}" >{{trans('lang.reports')}}</a></li>
        <li class="breadcrumb-item active">{{trans('lang.driver_reports')}}</li>
      </ol>
    </div>
</div>
  ...
  <div class="row">
    <div class="col-12">
      ...
      <div class="card-body">
        ...
        @endif
        <form action="{{ route('driverreport.downloadExcelDriver') }}"   method="get"  enctype="multipart/form-data" id="create_driver">
          <!-- @csrf -->

          <div class="row restaurant_payout_create">
              <div class="restaurant_payout_create-inner">
                <fieldset>
                  <legend>{{trans('lang.driver_reports')}}</legend>
