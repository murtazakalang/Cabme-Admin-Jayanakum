...
<div class="navbar-collapse">
    ...
    <ul class="navbar-nav mr-auto mt-md-0">
        ...
        <li class="nav-item m-l-0"><a class="nav-link sidebartoggler hidden-sm-down text-muted waves-effect waves-dark" href="javascript:void(0)"><svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 19 19" fill="none">
        ...
        <li class="nav-item">
            <span class="nav-link text-muted waves-effect waves-dark">{{ $app_setting->admin_title }}</span>
        </li>
    </ul>
