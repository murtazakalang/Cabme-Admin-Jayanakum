...
@section('content')
    <div class="page-wrapper">
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{!! route('notifications.index') !!}">{{trans('lang.notification')}}</a></li>
        ...
        <div class="card-body">
            ...
            @endif
            <form action="{{route('notifications.send')}}" method="post" enctype="multipart/form-data" id="send_notification">
                @csrf
                        ...
                        <fieldset>
                            ...
                            <div class="form-group row width-50">
                                <div class="form-check">
                                    ...
                                    <div class="form-text text-muted">
                                        {{ trans("lang.notification_send_help") }}
                                    </div>
                                </div>
                            </div>
                        </fieldset>
                ...
                <div class="form-group col-12 text-center btm-btn">
                    <button type="submit" class="btn btn-primary  save-form-btn"><i class="fa fa-save"></i> {{ trans('lang.send_notification')}}</button>
