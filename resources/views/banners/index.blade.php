                    ...
                    <div class="col-12">
                        <div class="d-flex top-title-section pb-4 justify-content-between">
                            <div class="d-flex top-title-left align-self-center">
                                ...
                                <h3 class="mb-0">{{ trans('lang.banners') }}</h3>
                        ...
                        <div class="card border">
                            <div class="card-header d-flex justify-content-between align-items-center border-0">
                                <div class="card-header-title">
                                    <h3 class="text-dark-2 mb-2 h4">{{ trans('lang.banners') }}</h3>
                                    <p class="mb-0 text-dark-2">{{ trans('lang.banners_table_text') }}</p>
                                </div>
                                <div class="card-header-right d-flex align-items-center">
                                    <div class="card-header-btn mr-3">
                                        <a class="btn-primary btn rounded-full" href="{!! route('banners.create') !!}"><i class="mdi mdi-plus mr-2"></i>{{ trans('lang.create_banner') }}</a>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                                ...
                                                <form action="{{ route('banners.index') }}" method="get">
                                                   <select name="selected_search" id="selected_search" class="form-control input-sm">
                                                    ...
                                                    <div class="search-box position-relative">
                                                        ...
                                                        <a class="btn btn-warning btn-flat" href="{{ url('banners') }}">{{ trans('lang.clear') }}</a>
                                                    </div>
                                                </form>
                                            </div>
                                        </label>
                                ...
                                <div class="table-responsive m-t-10">
                                            ...
                                            @if (count($banners) > 0)
                                                @foreach ($banners as $value)
                                                    <tr>
                                                        ...
                                                        @endcan
                                                        @if (file_exists(public_path('assets/images/banners' . '/' . $value->image)) && !empty($value->image))
                                                            <td><img class="rounded" style="width:50px" src="{{ asset('assets/images/banners') . '/' . $value->image }}" alt="image">
                                                            <a href="{{ route('banners.edit', ['id' => $value->id]) }}">{{ $value->title }}</a>
                                                            </td>
                                                        @else
                                                        ...
                                                        <td class="action-btn">
                                                            <a href="{{ route('banners.edit', ['id' => $value->id]) }}"><i class="mdi mdi-lead-pencil" data-toggle="tooltip" data-bs-original-title="{{ trans('lang.edit') }}"></i></a>
                                                            @can('banners.delete')
                                                            <a href="{{ route('banners.delete', ['id' => $value->id]) }}" class="delete-btn"><i class="mdi mdi-delete" data-toggle="tooltip" data-bs-original-title="{{ trans('lang.delete') }}"></i></a>
                                                            @endcan
                                                        </td>
                                                    </tr>
                                                @endforeach
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        <div>
                                            {{trans('lang.showing')}} {{ $banners->firstItem() }} {{trans('lang.to_small')}} {{ $banners->lastItem() }} {{trans('lang.of')}} {{ $banners->total() }} {{trans('lang.entries')}}
                                        </div>
                                        <div>
