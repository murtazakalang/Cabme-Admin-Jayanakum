    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor">
                @if(request()->is('fleet-drivers/approved'))
                    {{ trans('lang.all_approved_fleet_drivers') }}
                @elseif(request()->is('fleet-drivers/pending'))
                    {{ trans('lang.all_pending_fleet_drivers') }}
                @else
                    {{ trans('lang.all_fleet_drivers') }}
                @endif
            </h3>
        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="d-flex top-title-section pb-4 justify-content-between">
                        ...
                        <form action="{{ route('fleetdrivers.index') }}" method="get" id="filterForm">
                          ...
                          <div class="userlist-topsearch-flex mb-3">
                            ...
                            <div class="userlist-topsearch d-flex mb-0">
                                <div id="users-table_filter" class="ml-auto">
                                    <label>{{ trans('lang.search_by')}}
                                        <div class="form-group mb-0">
                                            <form action="{{ route('fleetdrivers.index') }}" method="get">
                                                <select name="selected_search" id="selected_search" class="form-control input-sm">
                                                    ...
                                                    <option value="owner" {{ request('selected_search') == 'owner' ? 'selected' : '' }}>
                                                        {{ trans('lang.owner_name') }}
                                                    </option>
                                                    <option value="vehicle_type" {{ request('selected_search') == 'owner' ? 'selected' : '' }}>
                                                ...
                                                <div class="search-box position-relative">
                                                    ...
                                                    <a class="btn btn-warning btn-flat" href="{{url('fleet-drivers')}}">{{trans('lang.clear')}}</a>
                                                </div>
                                            </form>
                                        </div>
                                    </label>
                            ...
                            <div class="dropdown text-right">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="exportDropdown">
                                    <li><a class="dropdown-item" href="{{ route('export.data', ['type' => 'excel', 'model' => 'FleetDriver']) }}">{{ trans("lang.export_excel") }}</a></li>
                                    <li><a class="dropdown-item" href="{{ route('export.data', ['type' => 'pdf', 'model' => 'FleetDriver']) }}">{{ trans("lang.export_pdf") }}</a></li>
                                    <li><a class="dropdown-item" href="{{ route('export.data', ['type' => 'csv', 'model' => 'FleetDriver']) }}">{{ trans("lang.export_csv") }}</a></li>
                                </ul>
                            </div>
                           </div>
                                ...
                                <table id="example24"
                                    ...
                                    <tbody id="append_list12">
                                        ...
                                        <tr>
                                            ...
                                            @if(!empty($driver->ownerNom))
                                                <td><a href="{{route('owners.show', ['id' => $driver->ownerId])}}">{{$driver->ownerPrenom.' '.$driver->ownerNom}}</a></td>
                                            @else
                                                <td>-</td>
                                            @endif
                                            <td>{{ $driver->email}}</td>
                                            ...
                                            <td>@foreach($totalRide as $ride)
                                                ...
                                                @endif
                                                @endforeach
                                                <a href="{{route('rides.index',['id'=>$driver->id])}}"><?php echo $count; ?></a>
                                            </td>
                                            <td>
