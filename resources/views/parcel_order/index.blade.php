                    ...
                    <div class="col-12">
                        <div class="d-flex top-title-section pb-4 justify-content-between">
                            <div class="d-flex top-title-left align-self-center">
                                ...
                                <h3 class="mb-0">{{ trans('lang.parcel_orders') }}</h3>
                                <span class="counter ml-3">{{ $totalLength }}</span>
                            </div>
                            <form action="{{ route('parcel.index') }}" method="get" id="filterForm">
                        ...
                        <div class="card border">
                            <div class="card-header d-flex justify-content-between align-items-center border-0">
                                <div class="card-header-title">
                                    <h3 class="text-dark-2 mb-2 h4">{{ trans('lang.parcel_orders') }}</h3>
                                        ...
                                        <div id="users-table_filter" class="ml-auto">
                                            <label>{{ trans('lang.search_by') }}
                                                <div class="form-group  mb-0">
                                                    ...
                                                    <a class="btn btn-warning btn-flat" href="{{ url('parcel') }}">{{trans('lang.clear')}}</a>
                                                    </form>
                                                </div>
                                            </label>
                                        </div>
                                            ...
                                            @if (count($rides) > 0)
                                                @foreach ($rides as $ride)
                                                    <tr>
                                                        ...
                                                        @endcan
                                                        <td><a href="{{ route('parcel.show', ['id' => $ride->id]) }}">{{ $ride->id }}</a></td>
                                                        <td><a href="{{ route('parcel.show', ['id' => $ride->id]) }}">{{ $ride->booking_number }}</a></td>  
                                                        <td>
                                                            @if($ride->user_id)
                                                                <a href="{{ route('users.show', ['id' => $ride->user_id]) }}">{{ $ride->userPrenom }} {{ $ride->userNom }}</a>
                                                            @endif
                                                        </td>
                                                        <td>
                                                        ...
                                                        <?php 
                                                        $total_price = floatval($ride->amount) - floatval($ride->discount);
                                                        ...
                                                        <td class="action-btn">
                                                            <a href="{{ route('parcel.show', ['id' => $ride->id]) }}" class="" data-toggle="tooltip" data-bs-original-title="{{ trans('lang.view_details') }}"><i class="mdi mdi-eye"></i></a>
                                                            @can('parcel.delete')
                                                            <a id="'+val.id+'" class="delete-btn" name="user-delete" href="{{ route('parcel.delete', ['rideid' => $ride->id]) }}" data-toggle="tooltip" data-bs-original-title="{{ trans('lang.delete') }}"><i class="mdi mdi-delete"></i></a>
                                                            @endcan
                                                        </td>
                                                    </tr>
                                                @endforeach
