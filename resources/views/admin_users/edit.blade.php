    ...
    <div class="profile-form">
        ...
        @endif
            ...
            <div class="form-group col-12 text-center btm-btn">
                @if($user->id != 1)
                    <button type="submit" class="btn btn-primary  edit-form-btn" id="save_user_btn">
                        <i class="fa fa-save"></i> {{ trans('lang.save')}}
                    </button>
                @endif 
                <a href="{!! route('admin-users.index') !!}" class="btn btn-default"><i class="fa fa-undo"></i>{{ trans('lang.cancel')}}</a>
            </div>
            </form>
        </div>
    </div>
