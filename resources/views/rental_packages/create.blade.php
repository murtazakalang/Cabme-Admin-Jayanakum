    ...
    <div class="page-wrapper">
        ...
        <div class="container-fluid">
            <div class="card-body">
                ...
                @endif
                <form action="{{ route('rental-packages.store') }}" method="post" enctype="multipart/form-data"
                    id="create_driver">
                    @csrf
                        ...
                        <div class="restaurant_payout_create-inner">
                            <fieldset>
                                ...
                                <div class="form-group row width-50">
                                    ...
                                    <div class="col-7">
                                        <input type="number" class="form-control" id="baseFare" name="baseFare" value="{{ old('baseFare') }}">
                                ...
                                <div class="form-group row width-50">
                                    ...
                                    <div class="col-7">
                                        <input type="number" class="form-control" id="includedHours" name="includedHours" value="{{ old('includedHours') }}">
                                ...
                                <div class="form-group row width-50">
                                    ...
                                    <div class="col-7">
                                        <input type="number" class="form-control" id="includedDistance" name="includedDistance" value="{{ old('includedDistance') }}">
                                ...
                                <div class="form-group row width-50">
                                    ...
                                    <div class="col-7">
                                        <input type="number" class="form-control" id="extraKmFare" name="extraKmFare" value="{{ old('extraKmFare') }}">
                                ...
                                <div class="form-group row width-50">
                                    ...
                                    <div class="col-7">
                                        <input type="number" class="form-control" id="extraMinuteFare" name="extraMinuteFare" value="{{ old('extraMinuteFare') }}">
                                ...
                                <div class="form-group row width-50">
                                    ...
                                    <div class="col-7">
                                        <input type="number" class="form-control" id="ordering" name="ordering" value="{{ old('ordering') }}">
                                        <div class="form-text text-muted">{{ trans('lang.enter_package_ordering') }}</div>
                                    </div>
                                </div>
                                <div class="form-group row width-50">
                                    <div class="form-check width-100">
                                        <input type="checkbox" id="published" name="published" {{ old('published') != null ? 'checked' : '' }}>
                    ...
                    <div class="form-group col-12 text-center btm-btn">
                        ...
                        <a href="{{ url('rental-packages') }}" class="btn btn-default"><i
