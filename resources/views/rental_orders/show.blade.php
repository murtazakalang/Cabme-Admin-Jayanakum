    ...
    <div class="page-wrapper ridedetail-page">
        <div class="row page-titles non-printable">
            <div class="col-md-5 align-self-center">
                <h3 class="text-themecolor">{{ trans('lang.rental_detail') }}</h3>
            </div>
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{!! route('rental-orders.index') !!}">{{ trans('lang.all_rental') }}</a>
                    </li>
                    <li class="breadcrumb-item active">
                        {{ trans('lang.rental_detail') }}
                    </li>
                </ol>
            </div>
        </div>
                                    ...
                                    <div class="order_detail-top mb-3 ">
                                        <div class="row">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="order_detail-top-box">
                                                            <div class="form-group row widt-100 gendetail-col">
                                                                <label class="col-12 control-label"><strong>{{ trans('lang.rental_id') }}
                                                            ...
                                                            <div class="form-group row widt-100 gendetail-col">
                                                                <label class="col-12 control-label">
                                                                    <strong>{{ trans('lang.rental_status') }} : </strong>                                                                
                                                                    <span id="payment_status">
                                                        ...
                                                        <div class="address order_detail-top-box user-details">
                                                            <p>
                                                                ...
                                                                <span class="billing_name d-flex">
                                                                    <span class="drove-det"><span class="drv-name">
                                                                            {{ $ride->userPrenom && $ride->userNom ? $ride->userPrenom . ' ' . $ride->userNom  : 'N/A' }}
                                                                        </span>
                                                                    </span>
                                                                </span>
                                                            </p>
                                            ...
                                            <div class="order_edit-genrl col-md-6">
                                                <div class="card">
                                                    <div class="card-header bg-white">
                                                        <h3>{{ trans('lang.package_details') }}</h3>
                                                    </div>
                                                    <div class="card-body">
                                                        <div class="address order_detail-top-box package-details">
                                                            <p>
                                                                <strong>{{ trans('lang.name') }}: </strong>
                                                                <span class="package_name d-flex">
                                                                    <span class="drove-det"><span class="pack-name">
                                                                             {{ $ride->package_title }} 
                                                                        </span>
                                                                    </span>
                                                                </span>
                                                            </p>
                                                            <p><strong>{{ trans('lang.description') }}:</strong>
                                                                <span id="package_description">
                                                                    {{ $ride->package_description }}
                                                                </span>
                                                            </p>
                                                            <p><strong>{{ trans('lang.package_base_fare') }}:</strong>
                                                                <span id="package_basefare">
                                                                    @if ($currency->symbol_at_right == "true")
                                                                        {{ number_format($ride->package_baseFare, $currency->decimal_digit) . $currency->symbole }}
                                                                    @else
                                                                        {{ $currency->symbole . number_format($ride->package_baseFare, $currency->decimal_digit) }}
                                                                    @endif
                                                                </span>
                                                            </p>
                                                            <p><strong>{{ trans('lang.package_included_hours') }}:</strong>
                                                                <span id="package_included_hours">
                                                                    {{ $ride->package_includedHours  }} H
                                                                </span>
                                                            </p>
                                                            <p><strong>{{ trans('lang.package_included_distance') }}:</strong>
                                                                <span id="package_included_distance">
                                                                    {{ $ride->package_includedDistance  }} Km
                                                                </span>
                                                            </p>
                                                            <p><strong>{{ trans('lang.package_extra_km_fare') }}:</strong>
                                                                <span id="package_extra_km_fare">
                                                                    @if ($currency->symbol_at_right == "true")
                                                                        {{ number_format($ride->package_extraKmFare, $currency->decimal_digit) . $currency->symbole }}
                                                                    @else
                                                                        {{ $currency->symbole . number_format($ride->package_extraKmFare, $currency->decimal_digit) }}
                                                                    @endif
                                                                </span>
                                                            </p>
                                                            <p><strong>{{ trans('lang.package_extra_min_fare') }}:</strong>
                                                                <span id="package_extra_min_fare">
                                                                    @if ($currency->symbol_at_right == "true")
                                                                        {{ number_format($ride->package_extraMinuteFare, $currency->decimal_digit) . $currency->symbole }}
                                                                    @else
                                                                        {{ $currency->symbole . number_format($ride->package_extraMinuteFare, $currency->decimal_digit) }}
                                                                    @endif
                                                                </span>
                                                            </p>
                                                        </div>
                                                        ...
                                                        <div class="card">
                                                            ...
                                                            <div class="card-body">
                                                                <a href="#" class="row redirecttopage" id="resturant-view">
                                                                    ...
                                                                    <div class="col-8">
                                                                        <h4 class="vendor-title"> {{ ($ride->driverPrenom || $ride->driverNom) 
                                                                            ? trim($ride->driverPrenom . ' ' . $ride->driverNom) 
                                                                            : 'N/A' }}</h4>
                                                                ...
                                                                <p><strong>{{ trans('lang.email') }}
                                                                        :</strong>
                                                                    <span id="vendor_email">{{ $ride->driver_email ?: 'N/A' }}</span>
                                                                </p>
                                                                <p><strong>{{ trans('lang.phone') }}
                                                                        :</strong>
                                                                    <span id="vendor_phone">{{ $ride->driver_phone ?: 'N/A'}}</span>
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="order-deta-btm mt-4">
                                        <div class="row">                                           
                                             <div class="col-md-6 order-deta-btm-right">                                                                         
                                                <div class="card">
                                                    <div class="card-header bg-white">
                                                        <h3 class="box-title">{{ trans('lang.driver_review') }}</h3>
                                                    </div>
                                                    <div class="card-body">
                                                        <p>
                                                            ...
                                                            <div class="box card-body p-0">
                                                                ...
                                                                <div class="card-body">
                                                                    <a href="{{ route('owners.show', ['id' => $ride->ownerId]) }}" class="row redirecttopage" id="resturant-view">
                                                                        ...
                                                                        <div class="col-8">
                                                                            <h4 class="vendor-title">{{ ($ride->ownerPrenom || $ride->ownerNom) 
                                                                            ? trim($ride->ownerPrenom . ' ' . $ride->ownerNom) 
                                                                            : 'N/A' }}</h4>
                                                                        </div>
                                                                    </a>
                                                                    <h5 class="contact-info">{{ trans('lang.contact_info') }}:</h5>
                                                                    <p><strong>{{ trans('lang.email') }}:</strong>
                                                                        <span id="vendor_email">{{ $ride->owner_email ?: 'N/A' }}</span>
                                                                    </p>
                                                                    <p><strong>{{ trans('lang.phone') }}:</strong>
                                                                        <span id="vendor_email">{{ $ride->owner_phone ?: 'N/A' }}</span>
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                                            ...
                                                                            <div class="table-responsive bk-summary-table">
                                                                                <table class="order-totals">
                                                                                    <tbody id="order_products_total">
                                                                                        ...
                                                                                        @if ($ride->base_fare > 0)
                                                                                        <tr>
                                                                                            <td>{{ trans('lang.base_fare') }}</td>
                                                                                            <td>@if ($currency->symbol_at_right == "true")
                                                                                                {{ number_format($ride->base_fare, $currency->decimal_digit) . $currency->symbole }}
                                                                                            @else
                                                                                                {{ $currency->symbole . number_format($ride->base_fare, $currency->decimal_digit) }}
                                                                                            @endif</td>
                                                                                        </tr>
                                                                                        @endif
                                                                                        @if ($ride->extra_minutes_cost > 0)
                                                                                        <tr>
                                                                                            <td>
                                                                                                {{ trans('lang.extra_time_cost') }}
                                                                                                ({{trans('lang.included')}}: {{ $ride->included_hours }} H,
                                                                                                {{trans('lang.extra')}}: {{ $ride->extra_hours }} H {{ $ride->extra_minutes }} M)
                                                                                            </td>
                                                                                            <td style="color:red">
                                                                                                @if ($currency->symbol_at_right == "true")
                                                                                                    {{ number_format($ride->extra_minutes_cost, $currency->decimal_digit) . $currency->symbole }}
                                                                                                @else
                                                                                                    {{ $currency->symbole . number_format($ride->extra_minutes_cost, $currency->decimal_digit) }}
                                                                                                @endif
                                                                                            </td>
                                                                                        </tr>
                                                                                        @endif
                                                                                        @if ($ride->extra_km_cost > 0)
                                                                                        <tr>
                                                                                            <td>
                                                                                                {{ trans('lang.extra_distance_cost') }}
                                                                                                ({{trans('lang.included')}}: {{ $ride->included_distance }} Km,
                                                                                                {{trans('lang.traveled')}}: {{ number_format($ride->total_distance, 2) }} Km,
                                                                                                 {{trans('lang.extra')}}: {{ number_format($ride->extra_km, 2) }} Km)
                                                                                            </td>
                                                                                            <td style="color:red">
                                                                                                 @if ($currency->symbol_at_right == "true")
                                                                                                    {{ number_format($ride->extra_km_cost, $currency->decimal_digit) . $currency->symbole }}
                                                                                                @else
                                                                                                    {{ $currency->symbole . number_format($ride->extra_km_cost, $currency->decimal_digit) }}
                                                                                                @endif
                                                                                            </td>
                                                                                        </tr>
                                                                                        @endif
                                                                                        ...
                                                                                        <tr class="final-rate">
                                                                                            ...
                                                                                            @php
                                                                                                $subtotal = $ride->base_fare + $ride->extra_minutes_cost + $ride->extra_km_cost;
                                                                                            @endphp
                                                                                             <td>{{ $currency->symbol_at_right == 'true' 
                                                                                                    ? number_format($subtotal, $currency->decimal_digit) . $currency->symbole 
                                                                                                    : $currency->symbole . number_format($subtotal, $currency->decimal_digit) }}
                                                                                            </td>
                                                                                        </tr>
                                                                                        @if ($ride->discount > 0)
                                                                                            <tr>
