...
<div class="page-wrapper">
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{!! route('language.index') !!}">{{trans('lang.user_plural')}}</a></li>
    ...
    <div>
        ...
        <div class="form-group col-12 text-center btm-btn">
            ...
            <a href="{!! route('language.index') !!}" class="btn btn-default"><i class="fa fa-undo"></i>{{
                trans('lang.cancel')}}</a>
        </div>
